...
suspension_coil <- read.csv(file='Suspension_Coil.csv',check.names=F,stringsAsFactors = F) #read in dataset 
...
t.test(suspension_coil$PSI, subset=Manufacturing_Lot=="Lot2",mu = 1500)
t.test(suspension_coil$PSI, subset=Manufacturing_Lot=="Lot3",mu = 1500)